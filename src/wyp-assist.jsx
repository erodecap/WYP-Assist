...
export default function WYPAssist(){
  ...
  // Auth state
  const[authView,setAuthView]=useState(null); // null | "login" | "signup" | "account"
  const[checkoutMsg,setCheckoutMsg]=useState(null);
  const[kbOpen,setKbOpen]=useState(false);
  const { user, isPro, loading: authLoading, refreshSubscription } = useAuth();
  ...
  const tabList=[{id:"load",icon:"⚙",label:tx.tabLoad},{id:"pull",icon:"📋",label:tx.tabPull,pro:true},{id:"bridle",icon:"△",label:tx.tabBridle,pro:true},{id:"markout",icon:"📐",label:tx.tabMarkout,pro:true}];
